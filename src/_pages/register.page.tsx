...
const registerDataSchemaValidation = z.object({
  crm: flux === "medic"
    ? z.string().min(1, "CRM obrigatório") // se for médico, CRM é obrigatório
    : z.string().optional(), // se não for, é opcional
  name: z.string().min(1, "Nome obrigatório"),
  tel: z.string().min(14, "Número de telefone obrigatório"),
  email: z.string().email("E-mail inválido").optional(),
  privacy_policy: z.literal(true), // obrigatório aceitar
  afya_research: z.boolean().optional(), // opcional
});
...
async function onSubmit(data: FormDataValidation) {
  ...
  return (
    <BlankPage className="h-dvh overflow-hidden">
      {focusedInput && (
        <div ref={keyboardRef}>
          <Keyboard
      ...
      <div className="flex flex-1 flex-col py-10 gap-2 overflow-hidden">
        ...
        <div className="flex flex-1 flex-col justify-center gap-4 lg:gap-32 items-start">
          <header className="w-full flex flex-col gap-4 lg:gap-10">
            <h1 className="text-7xl font-black font-nunito leading-0 text-zinc-200">
              Olá, seja bem-vindo.
            </h1>
              ...
              <div>
                <Input>
                  ...
                  <Input.Field
                    ...
                    value={insertMaskPhone(phoneValue)}
...
{/* arrumar font do botao */}
              <div className="mb-36 font-nunito-italic ">
                <Button
                  type="submit"
                  onClick={(e) => {
                    e.stopPropagation(); // impede o handleClickOutside de disparar
                  }}
                >
                  Iniciar
                </Button>
